...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('templates') }}/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Oops! 😖 Anda tidak memenuhi syarat untuk ke halaman ini</p>
        <a href="{{ route('dashboard.admin') }}" class="btn btn-primary">Kembali</a>
        <div class="mt-3">
          <img
            src="{{ asset('templates') }}/assets/img/illustrations/page-misc-error-light.png"
