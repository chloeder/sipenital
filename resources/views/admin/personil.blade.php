...
@endpush
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Personil/</span>Semua Personil</h4>

    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Daftar Semua Personil</h5>
            <p class="mb-0">Total : <span>{{ $personil->count() }}</span></p>
        </div>
        <hr class="my-0" />
        <div class="card-body">
