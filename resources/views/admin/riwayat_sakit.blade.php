...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header d-flex  justify-content-between">
            ...
            <p class="mb-0">Total : <span>{{ $sakit->count() }}</span></p>
        </div>
        <hr class="my-0" />
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($sakit as $s)
                            <tr>
                                ...
                                @else
                                    <td>
                                        <a href="{{ route('admin.struktur', $s->satker->id) }}">
                                            <span
                                                class="fw-bold badge rounded-pill bg-label-dark">{{ $s->satker->nama_satker }}</span>
                                        </a>
                                    </td>
                                @endif
                                <td>{{ $s->pangkat }}</td>
                                ...
                                @else
                                    <td>
                                        <span class="fw-bold badge rounded-pill bg-label-danger">{{ $s->keterangan }}</span>
                                    </td>
                                @endif
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('admin.personil.detail', $s->id) }}">
                                                Lihat Detail</a>
                                        </div>
                                    </div>
                                </td>
