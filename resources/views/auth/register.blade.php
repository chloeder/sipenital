                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-4">Untuk buat akun, silahkan mengisi form dibawah ini.</p>
                        </div>


                        <form id="formAuthentication" class="mb-3" action="{{ route('register.auth') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" placeholder="Silahkan masukkan alamat email anda"
                                    value="{{ old('email') }}" />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <p class="text-center">
                            ...
                            <a href="{{ route('login') }}">
                                <span class="text-warning">Login Sekarang</span>
                            </a>
                        </p>
                    </div>
                </div>
